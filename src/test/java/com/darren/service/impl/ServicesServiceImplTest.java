...
public class ServicesServiceImplTest {
    ...
    @Test
    public void update() {
        String newServiceName = "All stations Cape town";
    ...
    @Test
    public void getAll() {
        Set<Services> servicesSetGetAll = servicesService.getAll();
