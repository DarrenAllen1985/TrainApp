...
public class LoginRepositoryImplTest {
    ...
    public static void setUp() {
        login = LoginFactory.createLogin("0001", "Tarryn", "Pass.123");
    ...
    @Test
    public void create() {
        Login createLogin = LoginFactory.createLogin("0002", "Jenna", "Pass.234");
    ...
    @Test
    public void delete() {
        Login deleteLogin = LoginFactory.createLogin("0467", "Darren", "OhMyWord");
