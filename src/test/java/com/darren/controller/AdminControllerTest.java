...
public class AdminControllerTest {
    ...
    @Before
    public void setUp() {
        Admin admin = AdminFactory.createAdmin("0001","1234", "Darren");
    ...
    @Test
    public void create() {
        Admin admin = AdminFactory.createAdmin("0002","2465", "Tarryn");
    ...
    public void update() {
        ...
        Admin admin = AdminFactory.createAdmin("0003","4658", "DaTa");
